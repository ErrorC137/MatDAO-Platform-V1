...
async function main() {
  ...
  const dummyResearcher = "0x70997970C51812dc3A010C7d01b50e0d17dc79C8" // Hardhat account #2
  ...
  await mockUSDC.approve(escrowAddress, fundAmount)
  await matDAO_Escrow.fundProject(fundAmount)
  ...
  await mockUSDC.approve(swapAddress, swapLiquidityUSDC)
  await mockIPT.approve(swapAddress, swapLiquidityIPT)
  await matDAO_Swap.addLiquidity(swapLiquidityUSDC, swapLiquidityIPT)
