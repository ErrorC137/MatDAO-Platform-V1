...
const TYPEWRITER_WORDS = ["research paper", "patent draft", "deep tech IP"]
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl">
        <div className="mb-8 text-center md:mb-10">
          <p className="mb-4 inline-flex items-center rounded-full border border-[#6efcff]/35 bg-[#6efcff]/10 px-4 py-1 text-[11px] uppercase tracking-[0.18em] text-[#c5fdff]">
            4-Layer IP Valuation & FTO Engine
          </p>
          ...
          <p className="mx-auto max-w-2xl text-sm text-white/70 md:text-lg">
            Automated IPC/CPC classification, semantic originality scoring, FTO claim overlap
            analysis, and USD financial anchoring for tokenization-ready deep tech IP.
          </p>
        </div>

        <div className="mb-12 grid grid-cols-1 gap-6 md:mb-14 md:grid-cols-3 md:gap-8">
          <LandingCard
            href="/ai-studio/valuation/submit"
            badge="Prototype pick"
            badgeColor="#f59e0b"
            title="Evaluate my research"
            description="Run structured due diligence from extraction to FTO risk scoring with evidence traces."
          ...
          <LandingCard
            ...
            description="Benchmark originality premium, defensibility, and investment confidence against patent landscape."
            cta="Benchmark now"
          ...
          <LandingCard
            ...
            description="Match your paper with IPC/CPC sector baselines, NACE codes, and strategic tokenization pricing."
            cta="Map demand"
        ...
        <div className="flex flex-col items-center gap-5">
          <Link href="/ai-studio/valuation/submit" className="inline-flex">
          ...
          <div className="grid w-full max-w-3xl grid-cols-1 gap-3 text-left sm:grid-cols-3">
            <div className="rounded-xl border border-white/15 bg-white/4 px-4 py-3 text-xs text-white/70 backdrop-blur-sm">
              ...
              <div>IPC/CPC/NACE semantic classification</div>
            </div>
            <div className="rounded-xl border border-white/15 bg-white/4 px-4 py-3 text-xs text-white/70 backdrop-blur-sm">
              <div className="mb-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-[#b8fcff]">Layer 2</div>
              <div>Patent vector similarity & FTO overlap</div>
            </div>
            <div className="rounded-xl border border-white/15 bg-white/4 px-4 py-3 text-xs text-white/70 backdrop-blur-sm">
              <div className="mb-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-[#b8fcff]">Layer 3</div>
              <div>USD valuation anchor + 30% HITL modifiers</div>
            </div>
          </div>
        </div>
      </div>
